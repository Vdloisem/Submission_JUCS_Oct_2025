...
* **Raw Search Exports:** Contains the unprocessed, raw export files (.CSV) directly obtained from the search tools/databases (e.g., `PhdSLR-...-RAW.csv`). These represent the initial corpus (n=290 for RQ1, n=362 for RQ2) *before* any screening.
