...
# Paths ------------------------------------------------------------------------
in_csv <- "PhdSLR-Multilingual_Software_Interoperability_Assessment (SQ2) - PhdSLR-Multilingual_Software_Interoperability_Assessment(SQ2)-Sub-question2.1-SCREENING(2).csv"
out_dir <- "slr_outputs_sq21"
...
# Useful column sets (adapt to your sheet if names differ)
...
# Save enriched CSV
write_csv(df2, file.path(out_dir, "SQ2.1_with_ReasonCode.csv"))
...
# --- Blinded re-coding pack (20%) + answer key (robuste) ----------------------
set.seed(42)

# Selection of existing meta columns
